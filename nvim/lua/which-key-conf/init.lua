...
-- Open Unfgo
vim.api.nvim_set_keymap('n', '<Leader>m', ':Unfog<CR>', {noremap = true, silent = true})
...
local mappings = {
    ...
    g = {
        ...
        d = {
            ...
            r = {":DiffviewRefresh<cr>", "Refresh diff"},
        },
    },
    f = {
        name = "+Search",
    ...
    p = {
        ...
        l = {":lua require('nabla').place_inline()<cr>", "Latex inline preview"},
            -- TODO: Create custom function to insert $ ... $, $$ ... $$ and run automatically
        L = {":LLPStartPreview", "Latex file preview"}
    },
}
